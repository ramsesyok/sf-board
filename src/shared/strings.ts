...
const en = {
  ...
  "legacyQueuePrompt": "{0} of {1} messages queued by an older SF Board version match channels in {2} and user {3}. Send these matching messages here? Choose this only if it is their original destination. The others will remain queued.",
  "legacyQueueUseCurrent": "Use this destination",
  "legacyQueueNoMatch": "{0} older queued messages remain on this computer. Their destination could not be confirmed with the current shared folder and user ID. Restore the original settings to retry.",
  "resend": "Resend",
  "pending": "Sending…",
...
const ja: Record<StringKey, string> = {
  ...
  "legacyQueuePrompt": "旧版の送信待ち {1} 件のうち {0} 件は、{2} のチャンネルとユーザー {3} に一致します。この {0} 件を送信しますか? 元の送信先と一致する場合だけ選んでください。残りは保留します。",
  "legacyQueueUseCurrent": "この送信先を使用",
  "legacyQueueNoMatch": "旧版の送信待ち {0} 件を保留しています。現在の共有フォルダとユーザー ID では送信先を確認できません。元の設定に戻して再試行してください。",
  "resend": "再送",
  "pending": "送信中…",
